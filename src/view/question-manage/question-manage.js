...
export const questionManage = {
  ...
  methods: {
    ...
    publishQuestionnaire(row) {
      ...
      this.post("/api/questionnaireIssue/publishQuestionnaire", params)
        .then(res => {
          Message({
            showClose: true,
            message: res.msg,
    ...
    getQuestionnaireRecord() {
      this.get("/api/questionnaire/findAllQuestionnaireIssueByUserId", {
        userId: localStorage.getItem("userId")
      }).then(res => {
    ...
    deleteQuestionnaireRecord(row) {
      this.post("/api/questionnaire/deleteQuestionnaireIssueById", {
    ...
    getStudentanswerList() {
      this.get("/api/questionnaire/findQuestionnaireCanFill", {
        userId: localStorage.getItem("userId")
      }).then(res => {
