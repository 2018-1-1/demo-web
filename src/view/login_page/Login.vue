<template>
   <div class="box">
     <div class="tab">
       <ul class="tab-menu">
         <li :class="{selected:index === num}" @click="toggleTab(item.toggleTab,index)" v-for="(item,index) of tabs">{{item.name}}</li>
       </ul>
       <div class="tab-box">
         <!--学生登录开始-->
         <student-login :is="currentTab" keep-alive></student-login>
         <!--导师登录开始-->
         <!--教务登录开始-->
       </div>
     </div>
