    ...
    <el-card style="padding-bottom:30px">
      <div style="width:90%;margin-bottom:50px">
        ...
        <div style="margin-top:30px">
          <el-input v-if="question.type=='text'" type="textarea" style="margin-left:-134px;width:700px" v-model="text"></el-input>
          <el-radio-group v-if="question.type=='radio'" v-model="choice" style="margin-left:-342px">
            <el-radio v-for="(it,answerKey) in question.questionAnswers" :key="answerKey" :label="it.answerValue" style="margin-left:50px;float:left">
            </el-radio>
          </el-radio-group>
          <el-checkbox-group v-if="question.type=='checkbox'">
            <el-checkbox v-for="(it,answerKey) in question.questionAnswers" :key="answerKey" :label="it.answerValue"
              ></el-checkbox>
          </el-checkbox-group>
        </div>
        <el-button type="primary" style="float:right" plain>下一题</el-button>
      </div>
